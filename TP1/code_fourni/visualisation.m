...
figure(11),clf
plot(0,0,'ko','linewidth',2); hold;
plot([0 1.5*max(x)],[0 0],'k-') % tracer le segment de droite permettant de 
% placer le nuage de points
plot(x,zeros(1,nb_indiv),'r*',x_mean,0,'b+','linewidth',3);grid on
...
title('des points sur le plan reel');
...
legend('individus','element moyen');
title("des points dans l'espace reel");
